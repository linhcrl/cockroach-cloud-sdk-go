...
- Added new audit log actions for MFA operations: `ENABLE_MFA_ENFORCEMENT`,
...
- Promoted `S3VpcEndpointId` field in `Region` model from Preview to general
  availability by removing the "Preview:" prefix from its description.
